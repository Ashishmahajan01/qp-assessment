...
public interface AdminRepository extends JpaRepository<Admin, Long> {
	...
	com.springBootImageApplication.beans.Admin checkAdminLogin(String email, String password);

	@Query(value = "select a from Admin a where a.email=?1")
	com.springBootImageApplication.beans.Admin findAdminByEmail(String email);
